...
public class UserManagementTests {
	...
	public static void invalidEmailLoginTest() {
		...
		// enter invalid email yummy@primetechschool.com and valid password
		// primetech@school
		...
		// then verify that an error message "These credentials do not match our
		// records." displays
	...
	public static void invalidPasswordLogin_test() {
		...
		// enter valid email dummy@primetechschool.com and valid password
				// primetech@school
